    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nivel_mcer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='perfiles', to='curriculum.nivelmcer')),
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.UniqueConstraint(condition=models.Q(('used_at__isnull', True)), fields=('usuario',), name='uq_active_reset_per_user')],
            },
        ),
    ]
